 ...
 * 路由：
 * - GET    /api/documents/recent             最近更新的 N 篇文档
 * - GET    /api/documents/:id                获取单个文档
 * - PUT    /api/documents/:id                更新文档（创建版本快照）
 * - GET    /api/documents/:id/versions       列出版本
 * - GET    /api/documents/:id/versions/:v    获取某版本内容
 * - POST   /api/documents/:id/rollback/:v    回滚到某版本
 * - GET    /api/categories/:id/documents     列出分类下文档
 */
@Controller()
